...
export const TEST_APP_CONTAINER_APP = "MUST READ";
...
export const TEST_ROOT_FILE_DEFAULT_APP = "MUST READ";
export const TEST_ROOT_FILE_ALT_APP = "Pyhdral Editor";
...
export const BASE_APP_TITLE = "Pyhdral";
export const BASE_APP_FAVICON = /^\/os-logo.png$/;
export const BASE_APP_FAVICON_TEXT = "/os-logo.png";
