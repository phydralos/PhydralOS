...
export const Lock = memo(() => (
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <path d="M22 14v-4c0-3.314-2.686-6-6-6s-6 2.686-6 6v4H6v14h20V14h-4zm-10-4c0-2.209 1.791-4 4-4s4 1.791 4 4v4H12v-4zm12 16H8V16h16v10zm-8-7c-1.105 0-2 .895-2 2 0 .738.405 1.376 1 1.723V25h2v-2.277c.595-.347 1-.985 1-1.723 0-1.105-.895-2-2-2z" />
  </svg>
));
