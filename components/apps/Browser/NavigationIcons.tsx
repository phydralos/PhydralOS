...
export const Incognito = memo(() => (
  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C9.79 2 8 3.79 8 6c0 1.31.63 2.46 1.6 3.19C7.18 9.73 5.5 11.66 5.5 14c0 .55.45 1 1 1h11c.55 0 1-.45 1-1 0-2.34-1.68-4.27-4.1-4.81C15.37 8.46 16 7.31 16 6c0-2.21-1.79-4-4-4zm0 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zM6.5 16c-.83 0-1.5.67-1.5 1.5S5.67 19 6.5 19s1.5-.67 1.5-1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5.67-1.5 1.5S16.67 19 17.5 19s1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zM12 17c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
  </svg>
));
