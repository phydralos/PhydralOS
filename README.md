...
![Screenshot](https://raw.githubusercontent.com/Pyhdral/Pyhdral-OS/refs/heads/main/public/screenshot.png?raw=true)
...
```
docker build -t pyhdral .
docker run -dp 3000:3000 --rm --name pyhdral pyhdral
```

##### Notes

- If during `yarn install` you receive the error `digital envelope routines::unsupported`, you need to set `NODE_OPTIONS` to `--openssl-legacy-provider` ([1](https://github.com/Pyhdral/Pyhdral-OS/blob/main/Dockerfile#L3), [2](https://github.com/Pyhdral/Pyhdral-OS/blob/main/.github/workflows/main.yml#L17), [3](https://stackoverflow.com/a/69699772/5895982))
